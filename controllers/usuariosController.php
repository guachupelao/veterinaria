...
class usuariosController extends Controller
{
    ...
    public function index()
    {
        ...
        $this->_view->assign('title', 'Sesiones');
        $this->_view->assign('usuarios', Usuario::select('id','funcionario_id'));
        $this->_view->assign('usuarios', Usuario::with('funcionario')->orderBy('id')->get());
    ...
    public function view($id = null)
    {
        ...
        $this->_view->assign('usuarios', Usuario::with(['funcionario','funcionario_id','usuario'])->find($this->filtrarInt($id)));
